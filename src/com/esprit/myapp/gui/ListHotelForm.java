...
public class ListHotelForm extends BaseForm{
    ...
    public ListHotelForm(Resources res)
    {
        ...
        ArrayList<Hotel>List = ServiceHotel.getInstance().getAllHotel();
        for(Hotel rec : List)
        {
    ...
    private void AddButton(Image img,  Hotel rec,Resources res) {
        ...
        Label libelle = new Label("libelle: "+rec.getLibelle(),"NewsTopLine2");
        Label localisation = new Label("localisation: "+rec.getLocalisation(),"NewsTopLine2");
        Label nbetoile = new Label("nbetoile: "+rec.getNbetoile(),"NewsTopLine2");
        Label nbchdispo = new Label("nbchdispo: "+rec.getNbchdispo(),"NewsTopLine2");
        Label descriptiontxt = new Label("Description: "+rec.getDescription_hotel(),"NewsTopLine2");
        createLineSeparator();
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if (dig.show("suppression","vouslez-vous supprimer cette Hotel?","Annuler","oui")){
                ...
                if(ServiceHotel.getInstance().deleteHotel(rec.getId()))  {
        ...
        lModifier.addPointerPressedListener(l ->{
            new UpdateHotelForm(res,rec).show();
        });



        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                BoxLayout.encloseX(libelle),
                BoxLayout.encloseX(localisation),
                BoxLayout.encloseX(nbetoile),
                BoxLayout.encloseX(nbchdispo),
