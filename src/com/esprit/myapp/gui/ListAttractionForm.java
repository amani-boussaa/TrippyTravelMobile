...
public class ListAttractionForm extends BaseForm {
    public ListAttractionForm(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste des attractions");
...
//
        ...
        RadioButton mesListes = RadioButton.createToggle("Listes des attractions", barGroup);
        ...
        mesListes.addActionListener((e) -> {
            ...
            final Dialog ipDlg = ip.showInifiniteBlocking();
              ListAttractionForm a = new ListAttractionForm(res);
              a.show();
            refreshTheme();
        });
        //button ajouter
        partage.addActionListener((e) -> {
            InfiniteProgress ip = new InfiniteProgress();
            final Dialog ipDlg = ip.showInifiniteBlocking();
            AjouterAttractionForm a = new AjouterAttractionForm(res);
            a.show();
            refreshTheme();
        });
        ...
        /**list article**/
        ArrayList<Attraction>list = ServiceAttraction.getInstance().getAllAttraction();
        for (Attraction attraction : list){
            addButton(res.getImage("news-item-1.jpg"),attraction.getLibelle(), attraction.getLocalisation(), attraction.getHorraire(), attraction,res);
        }
    }
    ...
    private void addButton(Image img,String libelle,String localisation, String horraire,Attraction attraction,Resources res) {
        ...
        Label libelletxt = new Label("Libelle: "+attraction.getLibelle(),"NewsTopLine2");
        Label localisationtxt = new Label("Localisation: "+attraction.getLocalisation(),"NewsTopLine2");
        Label horrairetxt = new Label("Horraire: "+attraction.getHorraire(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l->{
            ...
            if (dig.show("Suppression","Vous voulez supprimer cette Attraction?","Anuuler","Ok")){
                dig.dispose();
            }else{
                dig.dispose();
                //n3aytou l supprimerExcursion
                if (ServiceAttraction.getInstance().deleteAttraction(attraction.getId())){
        ...
        lUpdate.addPointerPressedListener(l->{
            new ModifierAttractionForm(res,attraction).show();
        });
